...
public class mainForm extends javax.swing.JFrame {
    ...
    public final void updateSeatTable() {
        try {
            ...
            int c = resultSet.getInt("totalCount");
            if (c <= 50) {
            ...
            int c1 = resultSet.getInt("totalCount");
            if (c1 <= 50) {
            ...
            int c2 = resultSet.getInt("totalCount");
            if (c2 <= 30) {
            ...
            resultSet = pst.executeQuery();
            int totalSeat_SE = 30;
            int c3 = resultSet.getInt("totalCount");
            if (c3 <= 30) {
            ...
            int c4 = resultSet.getInt("totalCount");
            if (c4 <= 25) {
            ...
            resultSet = pst.executeQuery();
            int totalSeat_AM = 60;
            int c5 = resultSet.getInt("totalCount");
            if (c5 <= 60) {
    ...
    private void updatetableStu() {
     ...
     public final void updateDeptDe() {
        try {
            String sql1 = "update department_details SET Filled = (SELECT count(*) FROM student_info where Department = 'CSTE') WHERE Department = 'CSTE';";
            pst = connection.prepareStatement(sql1);
            pst.executeUpdate();
            pst.close();

            String sql121 = "update department_details SET Filled = (SELECT count(*) FROM student_info where Department = 'ACCE') WHERE Department = 'ACCE';";
            pst = connection.prepareStatement(sql121);
            pst.executeUpdate();
            pst.close();

            String sql113 = "update department_details SET Filled = (SELECT count(*) FROM student_info where Department = 'ICE') WHERE Department = 'ICE';";
            pst = connection.prepareStatement(sql113);
            pst.executeUpdate();
            pst.close();

            String sql141 = "update department_details SET Filled = (SELECT count(*) FROM student_info where Department = 'SE') WHERE Department = 'SE';";
            pst = connection.prepareStatement(sql141);
            pst.executeUpdate();
            pst.close();

            String sql151 = "update department_details SET Filled = (SELECT count(*) FROM student_info where Department = 'EEE') WHERE Department = 'EEE';";
            pst = connection.prepareStatement(sql151);
            pst.executeUpdate();
            pst.close();

            String sql161 = "update department_details SET Filled = (SELECT count(*) FROM student_info where Department = 'AM') WHERE Department = 'AM';";
